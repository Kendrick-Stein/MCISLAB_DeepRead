...
## Notes
这篇是“模拟器替代真实 rollout”的关键锚点，和 [[Papers/2511-DreamGym]] / [[Papers/2411-WebDreamer]] 同属 world-model training infra。它对 [[Topics/WebEnvironment-Engine-Survey]] 的补充是：environment engine 不一定只是真实 browser 的工程化封装，也可以是可控的 learned/synthetic transition system。
