...
4. **Parameter efficiency**: 2B 模型在 specialist 和 generalist 两种设定下都击败 3-4B 的 [[2504-Pi05|π0.5]]、[[2602-GigaBrain05M|GigaBrain-0.1]]、Spirit-v1.5
...
| [[2602-GigaBrain05M|GigaBrain-0.1]] | 3B | 51.67 |
...
- [[2602-GigaBrain05M|GigaBrain-0.1]]：3B、world-model-powered VLA；DM0 Specialist 领先 ~10%
...
- 与 [[2602-GigaBrain05M|GigaBrain-0.1]] 同月发布且同 benchmark，对比框架现成；但 GigaBrain 走 world-model 路线，DM0 走 hybrid training 路线，两者代表 VLA 的两个不同优化轴，值得跨 paper 拉通比较
