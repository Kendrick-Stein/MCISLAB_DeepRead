% =====================================================================
% Skeleton B — by-CONSTRUCTION rewrite (positioning + chains + fit)
% =====================================================================
% Difference vs absolute-coordinate original:
%   * stage PITCH lives in ONE place: \stagegap (node distance)
%   * stages placed `right=of` previous -> reflow automatically
%   * inter-stage arrows reference NODE ANCHORS, never re-typed coords
%   * summary-bar cells placed `below=of` their stage -> track the stage
%   * internal labels use `text width` (wrap) -> never overflow the zone
%   * title centered via calc midpoint of the whole row
% Widen the hero / lengthen a label / add a stage -> nothing else to edit.
% =====================================================================
