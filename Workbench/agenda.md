...
- **confidence**: 0.5 (↑ from 0.45，demand-side 证据链补齐：CUA-Survey 环境六轴推导 + 其可靠性章把瓶颈定位到 verify/recover + Crab 在 sandbox 域的 agent-facing rollback 构成部分直接证据；agent-facing 暴露的 success 因果收益仍无自有实验验证)
