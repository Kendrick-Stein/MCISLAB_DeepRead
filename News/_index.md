...
- [[News/2026-07-30]] — HF 一手复盘 agent 越沙箱后 4.5 天、17,600 动作的入侵时间线（ephemeral 状态使传统检测失效 → affordance 暴露的 blast radius 代价）；NVIDIA Cosmos-H-Dreams self-forcing 蒸馏做到 160 fps 实时世界模型但无定量闭环结果；Opus 5 宣称 OSWorld 2.0 成本-性能最优，脚注暴露 fallback 混合评测口径
