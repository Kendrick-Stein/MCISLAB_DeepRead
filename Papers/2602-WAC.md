...
和 [[Topics/AgentRuntimePrimitives-Survey]] 的关系：WAC 属于 inference-time simulated branching，但 branch 不是真实状态。和 [[Reports/2026-07-08-WebAgentTrainingInfra-Pulse]] 的关系：它是 cost/fidelity ladder 中最低成本、最低真实性的一档。
